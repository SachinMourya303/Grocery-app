...
function SearchedProducts({ searchProduct , setCartId , setProductInfoId}) {
    ...
    return (
        ...
        <div>
            ...
            <div className="container-fluid bg-transparent">
                <div><NavLink to="/" className="bi bi-house text-success"> / </NavLink><NavLink to="/searchproducts" className="text-success">RESULT</NavLink></div>
                            ...
                            searchProduct.map((product) => {
                                return (
                                    <figure key={product.id} className="col-5 col-md-2 border rounded">
                                        <img src={product.image} alt={product.name} className="allproducts-list col-12" onClick={() => onImageClicked(product.id)}/>
