...
function AllProducts({ setCartId , setProductInfoId}) {
    ...
    return (
        ...
        <div>
            ...
            <div className="container-fluid bg-transparent">
                <div><NavLink to="/" className="bi bi-house text-success"> / </NavLink><NavLink to="/allproducts" className="text-success">ALLPRODUCTS</NavLink></div>
